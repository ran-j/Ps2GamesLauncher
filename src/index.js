    ...
    created() {
        ...
        window.addEventListener("gamepadconnected", function(e) {
            ...
            interval = setInterval(function(){
                ...
                // console.log(navigator.getGamepads()[e.gamepad.index].buttons[4]);

                if(navigator.getGamepads()[e.gamepad.index].buttons[5].pressed && !onlyOnce) { //RB
                    onlyOnce = true
                    _vm.refreshLibrary()
                } else if (navigator.getGamepads()[e.gamepad.index].buttons[4].pressed && !onlyOnce) { //LB
                    onlyOnce = true
                    _vm.editConfig()
                } else {
                    onlyOnce = false
